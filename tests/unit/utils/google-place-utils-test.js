...
test('returns full change set when place includes full information', function(assert) {
...
function getGooglePlaceRespone(){
  ...
  const lat = googlePlaceRespone.geometry.location.lat;
  const lng = googlePlaceRespone.geometry.location.lng;
  googlePlaceRespone.geometry.location.lat = () => lat;
  googlePlaceRespone.geometry.location.lng = () => lng;

  return googlePlaceRespone;
}
